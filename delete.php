...
elseif (isset($_POST["submit2"])) {
    ...
    $query = "DELETE FROM ". $_SESSION["tables"] . " WHERE(". $_SESSION["values"] .");";
    $queryString = $query;
...
<title>Delete Records | Concordia University Database System</title>
<body>
...
<div class="selection" <?php echo $tableSelect;?>>
    <form name="tablesForm" action="./delete.php" method="post">
        <label>Please Select the Table from which You Would Like to Delete Records<br/>
        </label>
        <?php
...
<div class="selection" <?php echo $attributeSelect;?>>
    <form name="attributesForm" action="./delete.php" method="post">
        <label>List of the <?php echo $_SESSION["tables"]?> Table's Column Names<br/>
        </label>
        <?php
        echo "<br/><ul>";
        ...
        <label>Please Enter the Deletion Criteria <br/>
...
<div class="selection" <?php echo $sqlError;?>>
    <form name="mySQLError" action="./delete.php" method="post">
...
<div class="results" <?php echo $showResults;?>>
    <form name="results" action="./delete.php" method="post">
